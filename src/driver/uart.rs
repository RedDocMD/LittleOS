use crate::{driver, driver::mmio::MMIODerefWrapper, print, sync::NullLock};
use core::fmt;
use cortex_a::asm;
use tock_registers::{
...
use super::mmio::MMIO_BASE;

const PL011_OFFSET: usize = 0x0020_1000;
const PL011_BASE: usize = MMIO_BASE + PL011_OFFSET;
...
impl PL011UartInner {
    ...
    const fn new() -> Self {
        Self {
            registers: unsafe { Registers::new(PL011_BASE) },
        }
    }
...
impl print::Write for PL011Uart {
